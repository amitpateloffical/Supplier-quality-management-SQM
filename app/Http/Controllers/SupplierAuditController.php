...
if (!empty($request->end_date) != $lastDocument->end_date) {
...
if (!empty($request->audit_end_date) != $lastDocument->audit_end_date) {
...
// QA Comments
if ($lastDocument->QA_Comments != $internalAudit->QA_Comments || !empty($request->QA_Comments)) {
