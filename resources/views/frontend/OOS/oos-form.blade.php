            ...
            <div id="CCForm1" class="inner-block cctabcontent">
                <div class="inner-block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="group-input ">
                                <label for="Short Description ">Others(Specify)</label>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input ">
                                <label for="Short Description ">In-Process Sample Stage</label>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for="Tnitiaror Grouo">Packaging Material type</label>
                                <select>
                                    <option>Enter Your Selection Here</option>
                                    <option>OOT</option>
                                    <option>Lab Incident</option>
            ...
            <div id="CCForm3" class="inner-block cctabcontent">
                <div class="inner-block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                <label for="Description Deviation">Impact of Root Cause</label>
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="summernote" name="Description_Deviation[]" id="summernote-1">
                                    </textarea>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for="Reference Recores">Recommended Actions Reference</label>
                                <select multiple id="reference_record" name="PhaseIIQCReviewProposedBy[]" id="">
                                    <option value=""> Enter Your Selection Here</option>
                                    <option value=""></option>
                                    <option value=""></option>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for="Reference Recores">Reference CAPA No.</label>
                                <select multiple id="reference_record" name="PhaseIIQCReviewProposedBy[]" id="">
                                    <option value=""> Enter Your Selection Here</option>
                                    <option value=""></option>
                                    <option value=""></option>
