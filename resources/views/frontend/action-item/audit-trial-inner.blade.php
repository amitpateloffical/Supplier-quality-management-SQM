                ...
                <header>
                    ...
                    @php
                        ...
                        $auditCollect = DB::table('audit_reviewers_details')
                            ->where(['doc_id' => $document->id, 'type' => 'Action-Item', 'user_id' => Auth::user()->id])
                            ->latest()
                            ->first();
                    @endphp
                            ...
                            <td>
                                <div>
                                    <strong> Action Name
                                        ...
                                        <a href="{{ route('notification-detail', ['slug' => 'ActionItem', 'id' => $dataDemo->id]) }}" target = "_blank">{{ $dataDemo->action ? $dataDemo->action : 'Not Applicable' }}<a>
                                    @else
