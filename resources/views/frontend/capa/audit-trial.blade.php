                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('/capashow/' . $document->id) }}"> Back
                                </a>
                            </button>
                            ...
                            <div class="modal-content">
                                ...
                                @php
                                    $reviewer = DB::table('audit_reviewers_details')
                                        ->where(['doc_id' => $document->id, 'type' => 'Capa'])
                                        ->get();
                                @endphp
                    ...
                    <tr>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                            ...
                            <td>
                                <div>
                                    <strong> Action Name
                                        :</strong> @if($dataDemo->action == "Notification")
                                        <a href="{{ route('notification-detail', ['slug' => 'CAPA', 'id' => $dataDemo->id]) }}" target = "_blank">{{ $dataDemo->action ? $dataDemo->action : 'Not Applicable' }}<a>
                                    @else
