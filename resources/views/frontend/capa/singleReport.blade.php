    ...
    <div class="inner-block">
        ...
        <td class="w-80">
            @if($data->capa_related_record)
                @php
                    $relatedRecords = explode(',', $data->capa_related_record);
                    
                @endphp
                @foreach($relatedRecords as $recordId)
                    @php
                        $record = $data->firstWhere('id', $recordId);
                    @endphp
                    @if($record)
                        {{ Helpers::getDivisionName($record->division_id) }}/CAPA/{{ date('Y') }}/{{ Helpers::recordFormat($record->record) }}<br>
                    @else
                        Not Applicable<br>
                    @endif
                @endforeach
            ...
            @endif
                    ...
                    <tr>
                        ...
                        <td class="w-80">@if($data->interim_containment){{ $data->interim_containment }}@else Not Applicable @endif</td>
                    </tr>
                    <tr>
            ...
            <div class="block">
                ...
                <table>
                    <tr>
                        ...
                        <th class="w-20">Plan Proposed On</th>
                    ...
                    <tr>
                        ...
                        <th class="w-20">QA More Info Required On</th>
