            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id, 'Change Control', 3))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
            ...
            <div class="control-list">
                ...
                <div id="change-control-fields">
                    <div class="container-fluid">
                        ...
                        <form id="CCFormInput" class="formSubmit" {{ route('CC.update', $data->id) }} method="POST"
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select multiple name="cft_reviewer_person[]"
                                                        ...
                                                        @foreach ($cft as $data1)
                                                            <option value="{{ $data1->id }}"
                                                                {{ in_array($data1->id, $cftReviewerIds) ? 'selected' : '' }}>
                                                                {{ $data1->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input" id="initiated_through_req">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="initiated_through_req"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->initiated_through_req }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                                                ...
                                                                @foreach (unserialize($docdetail->current_doc_no) as $key => $datas)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="text"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                class="removeBtnDD">Remove</button>
                                                                        </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="Warehouse_comments"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->Warehouse_comments }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="Engineering_comments"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->Engineering_comments }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="Instrumentation_comments"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->Instrumentation_comments }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="Validation_comments"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->Validation_comments }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="group-input">
                                                    ...
                                                    <div class="relative-container">
                                                        <textarea class="mic-input" name="risk_identification"
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->risk_identification }}</textarea>
                                                        @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                        @endcomponent
                                                    </div>
                                                </div>
                                ...
                                <div id="CCForm9" class="inner-block cctabcontent">
                                    <div class="inner-block-content">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if (!empty($closure->version_no))
                                                                        <input type="text" name="version_no[]"
                                                                            value="{{ unserialize($closure->version_no)[$key] ? unserialize($closure->version_no)[$key] : '' }}"
                                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>
                                                                    @else
                                                                        <input type="text" name="version_no[]"
                                                                            value=""
                                                                ...
                                                                <td>
                                                                    <input type="text" name="implementation_date[]"
                                                                        class="agenda-dates"
                                                                        value="{{ unserialize($closure->implementation_date)[$key] ? date('d M Y', strtotime(unserialize($closure->implementation_date)[$key])) : '' }}"
                                                                ...
                                                                <td><button
                                                                        {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                        type="text"
                                                                        class="removeaddAffectedDocumentsbtn">Remove</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                                <textarea class="mic-input" name="qa_closure_comments"
                                                    {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>{{ $data->qa_closure_comments }}</textarea>
                                                @component('frontend.forms.language-model', ['disabled' => $data->stage == 0 || $data->stage == 6])
                                                @endcomponent
                                            </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <div class="file-attachment-field">
                                                    ...
                                                    <div class="add-btn">
                                                        ...
                                                        <input
                                                            {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                            type="file" id="myfile" name="attach_list[]"
                                                            oninput="addMultipleFiles(this, 'attach_list')" multiple>
                                                    </div>
                                                </div>
                                            </div>
    ...
    @endforeach
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <textarea class="mic-input" name="due_date_extension"
                            ...
                            <div id="CCForm10" class="inner-block cctabcontent">
                                <div class="inner-block-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="cftNot_required_comment">CFT Review Not Required
                                                    Comment</label>
