                            ...
                            <div class="modal-content">
                                ...
                                @php
                                    $reviewer = DB::table('audit_reviewers_details')
                                        ->where(['doc_id' => $document->id, 'type' => 'Effectiveness-check'])
                                        ->get();
                                @endphp
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" id="type" name="type" value="Effectiveness-check">
                                    </div>
                            ...
                            <td>
                                <div>
                                    ...
                                    @if ($dataDemo->action == 'Notification')
                                        <a href="{{ route('notification-detail', ['slug' => 'EffectivenessCheck', 'id' => $dataDemo->id]) }}"
