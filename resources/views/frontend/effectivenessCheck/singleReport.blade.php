            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->not_effective_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->more_not_effective_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->effective_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->more_effective_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->not_effective_approval_complete_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">{{ $data->effective_approval_complete_comment }}</td>
                    </tr>
