    ...
    <div id="change-control-view">
            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <a class="text-white" href="{{ url('rcms/effective-audit-trial-show', $data->id) }}"> <button
                        ...
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id, 'Effectiveness Check', 7))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                        ...
                        @elseif($data->stage == 5 && Helpers::check_roles($data->division_id, 'Effectiveness Check', 7))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#rejection-modal">
        ...
        <div id="change-control-fields">
            <div class="container-fluid">
                ...
                <form class="formSubmit" action="{{ route('effectiveness.update', $data->id) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="group-input">
                                            ...
                                            <select id="select-state" placeholder="Select..."
                                                name="assign_to"{{ $data->stage == 0 || $data->stage == 6 || $data->stage == 4 ? 'disabled' : '' }}>
                                            ...
                                            <div style="position:relative;">
                                                <div class="relative-container">
                                                    ...
                                                    @component('frontend.forms.language-model', [
                                                        'disabled' => $data->stage == 0 || $data->stage == 6 || $data->stage == 4,
                                                    ])
                                                    @endcomponent
                                                </div>
                                            </div>
                                ...
                                @if ($data->Attachments)
                                    @foreach (json_decode($data->Attachments) as $file)
                                        <input id="ATFIFile-{{ $loop->index }}" type="hidden"
                                            name="existing_Attachments[{{ $loop->index }}]"
                                            value="{{ $file }}">
                                    @endforeach
                                @endif
                                <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div style="position:relative;">
                                            <div class="relative-container">
                                                <textarea type="text" name="effect_summary" class="mic-input"
                                                    {{ $data->stage == 0 || $data->stage == 6 || $data->stage == 4 ? 'disabled' : '' }}> {{ $data->effect_summary }}</textarea>
                                                <button class="mic-btn" type="button">
                                                    <i class="fas fa-microphone"></i>
                                                </button>
                                                @component('frontend.forms.language-model', [
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div style="position:relative;">
                                            <div class="relative-container">
                                                <textarea type="text" name="Effectiveness_Results" class="mic-input"
                                                    {{ $data->stage == 0 || $data->stage == 6 || $data->stage == 4 ? 'disabled' : '' }}>{{ $data->Effectiveness_Results }}</textarea>
                                                <button class="mic-btn" type="button">
                                                    <i class="fas fa-microphone"></i>
                                                </button>
                                                @component('frontend.forms.language-model', [
                                ...
                                @if ($data->Effectiveness_check_Attachment)
                                    @foreach (json_decode($data->Effectiveness_check_Attachment) as $file)
                                        <input id="EFCHATFile-{{ $loop->index }}" type="hidden"
                                            name="existing_Effectiveness_check_Attachment[{{ $loop->index }}]"
                                            value="{{ $file }}">
                                    @endforeach
                                @endif
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list"
                                                id="Effectiveness_check_Attachment">
                                                @if ($data->Effectiveness_check_Attachment)
                                                    @foreach (json_decode($data->Effectiveness_check_Attachment) as $file)
                                                        <h6 type="button" class="file-container text-dark"
                                                            style="background-color: rgb(243, 242, 240);">
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div style="position:relative;">
                                            <div class="relative-container">
                                                <textarea type="text" name="Addendum_Comments" class="mic-input"
                                ...
                                @if ($data->Addendum_Attachment)
                                    @foreach (json_decode($data->Addendum_Attachment) as $file)
                                        <input id="ADATFile-{{ $loop->index }}" type="hidden"
                                            name="existing_Addendum_Attachment[{{ $loop->index }}]"
                                            value="{{ $file }}">
                                    @endforeach
                                @endif
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                                    ...
                                                    @foreach (json_decode($data->Addendum_Attachment) as $file)
                                                        <h6 type="button" class="file-container text-dark"
                                                            ...
                                                            <a href="{{ asset('upload/' . $file) }}" target="_blank"><i
                                                                    ...
                                                                    style="font-size:20px; margin-right:-10px;"></i></a>
                                                            <a type="button" class="remove-file"
                                                                data-remove-id="ADATFile-{{ $loop->index }}"
                                                                data-file-name="{{ $file }}"
                                                                style="@if ($data->stage == 0 || $data->stage == 6 || $data->stage == 4) pointer-events: none; @endif"><i
                                                                    class="fa-solid fa-circle-xmark"
                                                                    style="color:red; font-size:20px;"></i></a>
                                            ...
                                            <div class="add-btn">
                                                ...
                                                <input
                                                    {{ $data->stage == 0 || $data->stage == 6 || $data->stage == 4 ? 'disabled' : '' }}
                                                    type="file" id="myfile" name="Addendum_Attachment[]"
                        ...
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div style="position:relative;">
                                            <div class="relative-container">
                                                <textarea name="Comments" class="mic-input"
                                                    {{ $data->stage == 0 || $data->stage == 6 || $data->stage == 4 ? 'disabled' : '' }}>{{ $data->Comments }}</textarea>
                                                <button class="mic-btn" type="button">
                                                    <i class="fas fa-microphone"></i>
                                                </button>
                                                @component('frontend.forms.language-model', [
                                ...
                                @if ($data->Attachment)
                                    @foreach (json_decode($data->Attachment) as $file)
                                        <input id="REATFile-{{ $loop->index }}" type="hidden"
                                            name="existing_Reference_Attachment[{{ $loop->index }}]"
                                            value="{{ $file }}">
                                    @endforeach
                                @endif
                                <div class="col-12">
                            ...
                            <div class="col-lg-12">
                                <div class="group-input">
                                    ...
                                    <select {{ $data->stage == 0 || $data->stage == 4 ? 'disabled' : '' }} multiple
                                        id="refer_record" name="refer_record[]">
                                        ...
                                        @foreach ($old_record as $new)
                                            @php
                                                ...
                                                $selected = in_array($recordValue, explode(',', $data->refer_record))
                                                    ? 'selected'
                                                    : '';
                                            @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <div class="static">{{ $data->not_effective_comment }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="group-input">
                                        <label for="More_Information_Required_By"> More Information Required By(Not
                                            Effective)</label>
                                        <div class="static">{{ $data->more_not_effective_by }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="group-input">
                                        <label for="More_Information_Required_On">More Information Required On(Not
                                            Effective)</label>
                                        <div class="static">{{ $data->more_not_effective_on }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <div class="static">{{ $data->more_not_effective_comment }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="group-input">
                                        <label for="More_Information_Required_By_Effective"> More Information Required
                                            By(Effective)</label>
                                        <div class="static">{{ $data->more_effective_by }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="group-input">
                                        <label for="More_Information_Required_On_Effective">More Information Required
                                            On(Effective)</label>
                                        <div class="static">{{ $data->more_effective_on }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <div class="static">{{ $data->more_effective_comment }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="group-input">
        ...
        <div class="modal fade" id="cancel-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="formSubmit" action="{{ route('moreinfo_effectiveness', $data->id) }}" method="POST">
                        @csrf
                        <!-- Modal body -->
        ...
        <div class="modal fade" id="signature-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="formSubmit" action="{{ url('rcms/send-effectiveness', $data->id) }}" method="POST">
                        @csrf
                        <!-- Modal body -->
                        <div class="modal-body">
                            <div class="mb-3 text-justify">
        ...
        <div class="modal fade" id="rejection-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="formSubmit" action="{{ url('rcms/effectiveness-reject', $data->id) }}" method="POST">
                        @csrf
                        <!-- Modal body -->
                        <div class="modal-body">
                            <div class="mb-3 text-justify">
