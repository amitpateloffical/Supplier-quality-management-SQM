...
@section('container')
    {{-- ======================================
                    DASHBOARD
    ======================================= --}}
    <div id="audit-trial" style="padding: 0px;">
...
<body>
    ...
    <header>
        ...
        @php
                ...
                $auditCollect = DB::table('audit_reviewers_details')->where(['doc_id' => $document->id, 'user_id' => Auth::user()->id])->latest()->first();
        @endphp
                ...
                <tr class="table_bg">
                    ...
                    <tr>
                     ...
                     <strong> Data Field Name :</strong><a href="{{ url('DeviationAuditTrialDetails', $dataDemo->id) }}">{{ $dataDemo->activity_type ? $dataDemo->activity_type  : "Not Applicable" }}</a> </div>
                      ...
                      <div style="margin-top: 5px;">  <strong>Performed On :</strong>{{$dataDemo->created_at ? Helpers::getdateFormat($dataDemo->created_at)  : "Not Applicable"}}</div>
