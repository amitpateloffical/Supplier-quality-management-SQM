                            ...
                            @else
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class="tiny" name="Engineering_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Kilo Lab Feedback"> Process Development Laboratory / Kilo Lab
                                            Feedback</label>
                                        <textarea class="tiny" name="Kilo_Lab_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                ...
                <div class="group-input">
                    ...
                    <div style="position:relative;">
                        <textarea 
                            ...
                            id="summernote-14" 
                            class="mic-input">{{ $data->hod_final_remarks }}
                        </textarea>
                        <button class="mic-btn" type="button">
                            <i class="fas fa-microphone"></i>
                        </button>
                ...
                <div class="group-input">
                    ...
                    <div style="position:relative;">
                        <textarea 
                            ...
                            id="qa_final_remarks" 
                            class="mic-input">{{ $data->qa_final_remarks }}
                        </textarea>
                        <button class="mic-btn" type="button">
                            <i class="fas fa-microphone"></i>
                        </button>
                        ...
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea 
                                    ...
                                    id="summernote-14" 
                                    class="mic-input" 
                                    {{ $data->stage == 7 ? 'required' : 'disabled' }}>{{ $data->initiator_final_remarks }}
                                </textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
