            ...
            $('#ReferenceDocument').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td><input disabled type="text" name="serial[]" value="' + serialNumber +
                        '"></td>' +
                        '<td><input type="text" name="Number[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}></td>' +
                        '<td><input type="text" name="ReferenceDocumentName[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}></td>' +
                        '<td><input type="text" name="Document_Remarks[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}></td>' +
                        '<td><button class="removeRowBtn">Remove</button></td>' +
                            ...
                            <div class="inner-block-content">
                                ...
                                <div class="col-lg-12 new-date-data-field">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="initiator_group_code"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <textarea name="short_description"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="docname"
                                                type="text" maxlength="255" required {{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} class="tiny-disable">{{ $data->short_description }}</textarea>
                                        </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select class="facility-name"
                                                                            name="facility_name[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                                                            id="facility_name">
                                                                    ...
                                                                    <td><input class="id-number" type="text"
                                                                            name="IDnumber[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                                        ...
                                                        @foreach (unserialize($grid_data1->ReferenceDocumentName) as $key => $temps)
                                                            <tr>
                                                                ...
                                                                <td><input class="ReferenceDocumentName" type="text"
                                                                        name="ReferenceDocumentName[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                    ...
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"  name="Description_Deviation[]" value="{{$data->Description_Deviation}}"></textarea>
                                    </div>
                                </div> --}}
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <textarea class={{$data->stage == 1 || $data->stage == 11? 'QAInitialRemark' : 'tiny-disable' }}
                                    ...
                                    <!-- <div class="col-md-12 mb-3">
                                        <div class="group-input">
                                            ...
                                            <textarea class="tiny-disable" name="Production_feedback" id="summernote-18">{{ $data1->Production_feedback }}
                                    </textarea>
                                        </div>
                                    </div> -->
                                    {{-- <div class="col-6">
                                <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable" name="Immediate_Action[]" value="{{$data->Immediate_Action}}"></textarea>
                                    </div>
                                </div> --}}
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea class={{$data->stage == 1 || $data->stage == 11? 'QAInitialRemark' : 'tiny-disable' }} name="Immediate_Action[]" {{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable" name="Preliminary_Impact[]" value="{{$data->Preliminary_Impact}}"></textarea>
                                    </div>
                                </div> --}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea  class={{$data->stage == 1 || $data->stage == 11? 'QAInitialRemark' : 'tiny-disable' }} name="Preliminary_Impact[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                            ...
                            <div class="inner-block-content">
                                ...
                                {{-- <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Capa Required">CAPA Required? <span
                                                    class="text-danger">*</span></label>
                                            <select
                                                name="capa_required"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                {{-- <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="QRM Required">QRM Required? <span
                                                    class="text-danger">*</span></label>
                                            <select
                                                name="qrm_required"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <script>
                                    ...
                                    {{-- <div class="group-input">
                                            ...
                                            <select name="customers"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} class="customers" id="customers" required>
                                                <option value="0"> -- Select --</option>
                                    ...
                                    {{-- <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            data-search="false" data-silent-initial-value-set="true" name="related_records[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} >
                                                <option value="">--Select---</option>
                                                @foreach ($pre as $prix)
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea @if ($data->stage == 3) required @endif class={{$data->stage == 3 || $data->stage == 11? 'QAInitialRemark' : 'tiny-disable' }}
                        ...
                        @else
                            <div class="row">
                                ...
                                {{-- <div class="col-5">
                                    <div class="group-input">
                                        ...
                                        @endphp
                                            ...
                                            <select disabled name="customers"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="customers" required>
                                                <option value="0"> -- Select --</option>
                                                @foreach ($customers as $data1)
                                                <option  @if ($data->customers == $data1->id) selected @endif
                                                    value="{{ $data1->id }}">{{ $data1->customer_name }}</option>
                                ...
                                {{-- <div class="col-12">
                                        <div class="group-input">
                                            <label for="related_records">Related Records<span class="text-danger d-none"></span></label>
                                            <select  multiple name="related_records[]" {{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} placeholder="Select Facility Name"
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea readonly class={{$data->stage == 3 || $data->stage == 11? 'QAInitialRemark' : 'tiny-disable' }}
                                            name="QAInitialRemark"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-6">{{ $data->QAInitialRemark }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    @if ($data->stage == 4)
                                        ...
                                        {{-- <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea class="tiny-disable" name="Production_feedback" id="summernote-18">{{ $data1->Production_feedback }}</textarea>
                                            </div>
                                        </div> --}}
                                    @else
                                        <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea disabled class={{$data->stage == 4 || Auth::user()->id == $data1->Production_person || $data->stage == 11 ? '' : 'tiny-disable' }} name="Production_assessment" id="summernote-17">{{ $data1->Production_assessment }}</textarea>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea disabled class="tiny-disable" name="Production_feedback" id="summernote-18">{{ $data1->Production_feedback }}</textarea>
                                            </div>
                                        </div> --}}
                                    @endif
                                ...
                                @if ($data->stage == 3 || $data->stage == 4)
                                    ...
                                    <div class="col-md-12 mb-3 warehouse">
                                        <div class="group-input">
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea @if ($data1->Warehouse_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Warehouse_assessment || $data->stage == 11 ? 'Warehouse_assessment' : 'tiny-disable' }}
                                    ...
                                    @if ($data->stage == 4)
                                        ...
                                        {{-- <div class="col-md-12 mb-3 warehouse">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if
                                                        it does not require completion</small></div>
                                                <textarea class="tiny-disable" name="Warehouse_feedback" id="summernote-20">{{ $data1->Warehouse_feedback }}</textarea>
                                            </div>
                                        </div> --}}
                            </div>
                        @else
                            ...
                            {{-- <div class="col-md-12 mb-3 warehouse">
                                <div class="group-input">
                                    ...
                                    <div><small class="text-primary">Please insert "NA" in the data field if it does not
                                            require completion</small></div>
                                    <textarea disabled class="tiny-disable" name="Warehouse_feedback" id="summernote-20">{{ $data1->Warehouse_feedback }}</textarea>
                                </div>
                            </div> --}}
                            @endif
                            {{-- <div class="col-12 warehouse">
                            ...
                            @if ($data->stage == 3 || $data->stage == 4)
                                ...
                                <div class="col-md-12 mb-3 quality_control">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea @if ($data1->Quality_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Quality_Control_Person || $data->stage == 11 ? 'Quality_Control_assessment' : 'tiny-disable' }}
                                ...
                                <div class="col-md-12 mb-3 quality_assurance">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea @if ($data1->Quality_Assurance_Review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->QualityAssurance_person || $data->stage == 11 ? 'QualityAssurance_assessment' : 'tiny-disable' }}
                                ...
                                <div class="col-md-12 mb-3 engineering">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea @if ($data1->Engineering_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Engineering_person || $data->stage == 11 ? 'Engineering_assessment' : 'tiny-disable' }}
                                    ...
                                    <div class="group-input">
                                        <label for="Impact Assessment5">Impact Assessment (By Analytical Development
                                            Laboratory) <span id="asteriskAD1"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Analytical_Development_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Analytical_Development_person || $data->stage == 11? 'Analytical_Development_assessment' : 'tiny-disable' }}
                                    ...
                                    <div class="group-input">
                                        <label for="Impact Assessment6">Impact Assessment (By Process Development
                                            Laboratory / Kilo Lab) <span id="asteriskPDL1"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Kilo_Lab_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Kilo_Lab_person || $data->stage == 11 ? 'Analytical_Development_assessment' : 'tiny-disable' }}
                                    ...
                                    <div class="group-input">
                                        <label for="Impact Assessment7">Impact Assessment (By Technology Transfer /
                                            Design) <span id="asteriskTT1"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Technology_transfer_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Technology_transfer_person || $data->stage == 11 ? 'Technology_transfer_assessment' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3 environmental_health">
                                    <div class="group-input">
                                        <label for="Safety Feedback">Environment, Health & Safety Feedback <span
                                                ...
                                                style="display: {{ $data1->Environment_Health_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Environment_Health_review == 'yes' && $data->stage == 4) required @endif class="tiny-disable" name="Health_Safety_feedback"
                                    ...
                                    <div class="group-input">
                                        <label for="productionfeedback">Impact Assessment (By Human Resource &
                                            Administration ) <span id="asteriskHR1"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Human_Resource_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Human_Resource_person || $data->stage == 11 ? 'Human_Resource_assessment' : 'tiny-disable' }}
                                    ...
                                    <div class="group-input">
                                        <label for="Impact Assessment10">Impact Assessment (By Information Technology)
                                            <span id="asteriskITP"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Information_Technology_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Information_Technology_person || $data->stage == 11 ? 'Information_Technology_assessment' : 'tiny-disable' }}
                                ...
                                <div class="col-md-12 mb-3 project_management">
                                    <div class="group-input">
                                        <label for="Impact Assessment11">Impact Assessment (By Project management ) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Project_management_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Project_management_person || $data->stage == 11 ? 'Project_management_assessment' : 'tiny-disable' }}
                            ...
                            @else
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Quality_Control_Person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class="tiny-disable"
                                            name="Quality_Control_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->QualityAssurance_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class="tiny-disable"
                                            name="QualityAssurance_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Engineering_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea class="tiny-disable" name="Engineering_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"
                                            name="Analytical_Development_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Kilo_Lab_person || $data->stage == 11 ? '' : 'tiny-disable' }} name="Kilo_Lab_assessment"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Kilo Lab Feedback"> Process Development Laboratory / Kilo Lab
                                            Feedback</label>
                                        <textarea class="tiny-disable" name="Kilo_Lab_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Impact Assessment7">Impact Assessment (By Technology Transfer /
                                            Design)</label>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Technology_transfer_person || $data->stage == 11 ? 'Technology_transfer_assessment' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"
                                            name="Technology_transfer_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Impact Assessment8">Impact Assessment (By Environment, Health &
                                            Safety)</label>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Environment_Health_Safety_person || $data->stage == 11? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"
                                            name="Health_Safety_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Human_Resource_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"
                                            name="Human_Resource_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Impact Assessment10">Impact Assessment (By Information
                                            Technology)</label>
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Information_Technology_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Information Technology Feedback">Information Technology
                                            Feedback</label>
                                        <textarea class="tiny-disable"
                                            name="Information_Technology_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny-disable"
                                            name="Project_management_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                                ...
                                <div class="col-md-12 mb-3 other1_reviews ">
                                    <div class="group-input">
                                        <label for="Impact Assessment12">Impact Assessment (By Other's 1) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Other1_review == 'yes' && $data->stage == 4) required @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Other1_person || $data->stage == 11 ? '' : 'tiny-disable' }} name="Other1_assessment"
                                ...
                                {{-- <div class="col-md-12 mb-3 other1_reviews ">
                                    <div class="group-input">
                                        <label for="Feedback1"> Other's 1 Feedback <span id=""
                                                style="display: {{ $data1->Other1_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Other1_review == 'yes' && $data->stage == 4) required @endif class="tiny-disable" name="Other1_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other2_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment13">Impact Assessment (By Other's 2) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other2_person) readonly @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Other2_person || $data->stage == 11? '' : 'tiny-disable' }} name="Other2_Assessment"
                                ...
                                {{-- <div class="col-md-12 mb-3 Other2_reviews">
                                    <div class="group-input">
                                        <label for="Feedback2"> Other's 2 Feedback <span id=""
                                                style="display: {{ $data1->Other2_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other2_person) readonly @endif class="tiny-disable" name="Other2_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other3_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment14">Impact Assessment (By Other's 3) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other3_person) readonly @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Other3_person || Auth::user()->id == $data1->Other3_person || $data->stage == 11 ? '' : 'tiny-disable' }} name="Other3_Assessment"
                                ...
                                {{-- <div class="col-md-12 mb-3 Other3_reviews">
                                    <div class="group-input">
                                        <label for="feedback3"> Other's 3 Feedback <span id=""
                                                style="display: {{ $data1->Other3_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other3_person) readonly @endif class="tiny-disable" name="Other3_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment15">Impact Assessment (By Other's 4) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other4_person) readonly @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Other4_person || $data->stage == 11 ? '' : 'tiny-disable' }} name="Other4_Assessment"
                                ...
                                {{-- <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        <label for="feedback4"> Other's 4 Feedback <span id=""
                                                style="display: {{ $data1->Other4_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other4_person) readonly @endif class="tiny-disable" name="Other4_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other5_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment16">Impact Assessment (By Other's 5) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other5_person) readonly @endif class={{$data->stage == 4 || Auth::user()->id == $data1->Other5_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3 Other5_reviews">
                                    <div class="group-input">
                                        <label for="productionfeedback"> Other's 5 Feedback <span id=""
                                                style="display: {{ $data1->Other5_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other5_person) readonly @endif class="tiny-disable"
                            ...
                            @else
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class={{$data->stage == 4 || Auth::user()->id == $data1->Other1_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class="tiny-disable"
                                            name="Other1_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-42">{{ $data1->Other1_feedback }}</textarea>
                                    </div>
                                </div> --}}
                                {{-- <div class="col-12">
                                    <div class="group-input">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class={{$data->stage == 4 || Auth::user()->id == $data1->Other2_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class="tiny-disable"
                                            name="Other2_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-44">{{ $data1->Other2_feedback }}</textarea>
                                    </div>
                                </div> --}}
                                {{-- <div class="col-12">
                                    <div class="group-input">
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class="tiny-disable"
                                            name="Other3_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-46">{{ $data1->Other3_Assessment }}</textarea>
                                    </div>
                                </div> --}}
                                {{-- <div class="col-12">
                                    <div class="group-input">
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class="tiny-disable"
                                            name="Other4_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-48">{{ $data1->Other4_feedback }}</textarea>
                                    </div>
                                </div> --}}
                                {{-- <div class="col-12">
                                    <div class="group-input">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class={{$data->stage == 4 || Auth::user()->id == $data1->Other5_person || $data->stage == 11 ? '' : 'tiny-disable' }}
                                ...
                                {{-- <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea disabled class="tiny-disable"
                                            name="Other5_feedback"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }} id="summernote-50">{{ $data1->Other5_feedback }}</textarea>
                                    </div>
                                </div> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <textarea class="tiny-disable" name="Discription_Event" id="summernote-8">{{ $data->Discription_Event }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="objective" id="summernote-9">{{ $data->objective }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="scope" id="summernote-10">{{ $data->scope }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="imidiate_action" id="summernote-10">{{ $data->imidiate_action }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="imidiate_action1" id="summernote-10">{{ $data->imidiate_action1 }}</textarea>
                        </div>
                    </div>
    ...
    @endif
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="Conclusion" id="summernote-8" value="{{$data->Conclusion}}">{{$data->Conclusion}}
                </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="Identified_Risk" value="{{$data->Identified_Risk}}" id="summernote-8">{{$data->Identified_Risk}}
                </textarea>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="group-input">
                        ...
                        <textarea class="tiny-disable" name="Description_of_Discrepancy" id="Description_of_Discrepancy" value="">{{$data->Description_of_Discrepancy}}</textarea>
                    </div>
                </div>
                <div class="col-md-12 mb-3">
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="capa_root_cause" id="capa_root_cause">{{ $data->capa_root_cause }}</textarea>
                    </div>
                </div>
                <div class="col-md-12 mb-3">
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Immediate_Action_Take" id="Immediate_Action_Take">{{ $data->Immediate_Action_Take }}</textarea>
                    </div>
                </div>
                    <div class="col-md-12 mb-3">
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Corrective_Action_Details" id="Corrective_Action_Details" value="">{{ $data->Corrective_Action_Details }}</textarea>
                    </div>
                </div>
                    <div class="col-md-12 mb-3">
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Preventive_Action_Details" id="Preventive_Action_Details" value="">{{ $data->Preventive_Action_Details }}</textarea>
                    </div>
                </div>
                    <div class="col-lg-6 new-date-data-field">
                    <div class="group-input input-date">
                    ...
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Interim_Control" id="Interim_Control" value="">{{ $data->Interim_Control }}</textarea>
                    </div>
                </div>
                    <div class="sub-head">
                            CAPA Implementation
                    ...
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Corrective_Action_Taken" id="Corrective_Action_Taken" value="">{{ $data->Corrective_Action_Taken }}</textarea>
                    </div>
                    ...
                    <div class="group-input">
                        ...
                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                        <textarea class="tiny-disable" name="Preventive_action_Taken" id="Preventive_action_Taken" value="">{{ $data->Preventive_action_Taken }}</textarea>
                    </div>
                </div>
                <div class="sub-head">
                            CAPA Closure
                            ...
                            <div class="file-attachment-field">
                                ...
                                <div class="add-btn">
                                    ...
                                    <input {{ $data->stage == 5 ? '' : 'disabled' }} type="file" id="myfile"
                                        name="QA_attachments[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div class="file-attachment-field">
                                ...
                                <div class="add-btn">
                                    <div>Add</div>
                                    <input {{ $data->stage == 10 ? '' : 'disabled' }} type="file" id="myfile"
                                        name="closure_attachment[]"{{ $data->stage == 0 || $data->stage == 11 ? 'disabled' : '' }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="Effectiveness_Check_Plan_Deviation" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny-disable" name="EC_Closure_comments_deviation" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6 new-date-data-field">
                        <div class="group-input input-date">
                        ...
                        <div class="modal-sub-head">
                            <div class="sub-main-head">
                                ...
                                <div class="left-box">
                                    ...
                                    <!-- Status -->
                                    <div class="Activity-type">
                                        <label style="font-weight: bold; margin-left: 42px;" for="status">Status<span
                                                class="text-danger">*</span> :</label>
                                ...
                                <div class="right-box">
                                    ...
                                    <!-- Contact No -->
                                    <div class="Activity-type">
                                        <label style="font-weight: bold; margin-left: 36px;" for="contact_no">Contact
                                    ...
                                    <!-- Region -->
                                    <div class="Activity-type">
                                        <label style="font-weight: bold; margin-left: 66px; " for="region">Region<span
                                                class="text-danger">*</span> :</label>
