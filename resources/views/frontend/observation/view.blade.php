            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <a class="text-white" href="{{ route('ShowObservationAuditTrial', $data->id) }}">
                            <button class="button_theme1">
                                Audit Trail </button>
                        </a>

                        @if ($data->stage == 1 && Helpers::check_roles($data->division_id, 'Observation', 41))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#rejection-modal">
                                Cancel
                            </button>
                        @elseif($data->stage == 1 && Helpers::check_roles($data->division_id, 'Observation', 18))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Report Issued
                            </button>
                        @elseif($data->stage == 2 && Helpers::check_roles($data->division_id, 'Observation', 42))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Complete
                            </button>
                        ...
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id, 'Observation', 43))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                QA Approval
                            </button>
                        ...
                        @elseif($data->stage == 4 && Helpers::check_roles($data->division_id, 'Observation', 18))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                All CAPA Closed
                            </button>
                        @elseif($data->stage == 5 && Helpers::check_roles($data->division_id, 'Observation', 43))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Final Approval
                            </button>
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#rejection-modal">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input disabled type="text"
                                                    value="{{ Helpers::getDivisionName($data->division_id) }}/OBS/{{ Helpers::year($data->created_at) }}/{{ $data->record }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                            ...
                                            <div class="group-input input-date ">
                                                ...
                                                <div class="calenderauditee">
                                                    ...
                                                    <input type="date" id="date_Response_due_checkdate"
                                                        ...
                                                        {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                        value="{{ $data->date_Response_due2 }}" class="hide-input"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <select name="impact"
                                                    ...
                                                    <option value="">-- Select --</option>
                                                    <option value="High"
                                                        {{ $data->impact == 'High' ? 'selected' : '' }}>
                                                        High</option>
                                                    <option value="Medium"
                                                        {{ $data->impact == 'Medium' ? 'selected' : '' }}>
                                                        Medium</option>
                                                    <option value="Low" {{ $data->impact == 'Low' ? 'selected' : '' }}>
                                                        Low</option>
                                                    <option value="None"
                                                        {{ $data->impact == 'None' ? 'selected' : '' }}>
                                                        None</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 new-date-data-field">
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    ...
                                                    <input type="date" value="{{ $data->actual_start_date }}"
                                            ...
                                            <div class="group-input input-date">
                                                <label for="actual_end_date">Actual End Date</lable>
                                                    <div class="calenderauditee">
                                                        ...
                                                        <input type="date" value="{{ $data->actual_end_date }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <div class="static">{{ $data->QA_Approved_Comment }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="group-input">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <div class="static">{{ $data->Reject_CAPA_Plan_Comment }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="group-input">
                                                ...
                                                <div class="static">{{ $data->Reject_CAPA_Plan_By1 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="group-input">
                                                <label for="Reject_CAPA_Plan_On1">Reject CAPA Plan On</label>
                                                <div class="static">{{ $data->Reject_CAPA_Plan_On1 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="Reject_CAPA_Plan_Comment1">Reject CAPA Plan Comment</label>
                                                <div class="static">{{ $data->Reject_CAPA_Plan_Comment1 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="group-input">
