            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($data->regulatory_climate)
                                {{ $data->regulatory_climate }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($data->risk_management_strategy)
                                {{ $data->risk_management_strategy }}
                            @else
                                Not Applicable
                            @endif
                        </td>
            ...
            <div class="head">
                ...
                <table>
                    - <tr>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->what_will_be)
                                {{ $riskgrdwhat_who_where->what_will_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->what_will_not_be)
                                {{ $riskgrdwhat_who_where->what_will_not_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->what_rationable)
                                {{ $riskgrdwhat_who_where->what_rationable }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->where_will_be)
                                {{ $riskgrdwhat_who_where->where_will_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->where_will_not_be)
                                {{ $riskgrdwhat_who_where->where_will_not_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->where_rationable)
                                {{ $riskgrdwhat_who_where->where_rationable }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->when_will_be)
                                {{ $riskgrdwhat_who_where->when_will_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->when_will_not_be)
                                {{ $riskgrdwhat_who_where->when_will_not_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->when_rationable)
                                {{ $riskgrdwhat_who_where->when_rationable }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->coverage_will_be)
                                {{ $riskgrdwhat_who_where->coverage_will_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->coverage_will_not_be)
                                {{ $riskgrdwhat_who_where->coverage_will_not_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->coverage_rationable)
                                {{ $riskgrdwhat_who_where->coverage_rationable }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->who_will_not_be)
                                {{ $riskgrdwhat_who_where->who_will_not_be }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                        ...
                        <td class="w-80">
                            @if ($riskgrdwhat_who_where->who_rationable)
                                {{ $riskgrdwhat_who_where->who_rationable }}
                            @else
                                Not Applicable
                            @endif
                        </td>
