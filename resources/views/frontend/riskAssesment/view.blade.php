                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        @php
                            ...
                            //         'q_m_s_processes_id' => $process_id,
                            //         'q_m_s_roles_id' => $role_id,
                            //     ])
                            //     ->first();
                            // $userRoleIds = $roleExists->pluck('q_m_s_roles_id')->toArray();
    ...
    ======================================= --}}
            <div id="change-control-fields">
                <div class="container-fluid">
                    ...
                    <form class="formSubmit" action="{{ route('riskUpdate', $data->id) }}" method="post"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="number" name="estimated_man_hours" id="estimated_man_hours"
                                                    {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                    value="{{ $data->estimated_man_hours }}" min="0">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="number" name="estimated_cost" id="estimated_cost"
                                                    {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                    value="{{ $data->estimated_cost }}" min="0">
                                            </div>
                                        </div>
                                        {{-- <div class="col-lg-6">
                                            <div class="group-input">
            ...
            <div class="modal fade" id="signature-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="formSubmit" action="{{ route('riskAssesmentStateChangeshow', $data->id) }}"
                            method="POST">
                            @csrf
                            <!-- Modal body -->
            ...
            <div class="modal fade" id="rejection-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="formSubmit" action="{{ url('reject_Risk', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
            ...
            <div class="modal fade" id="more_info-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="formSubmit" action="{{ url('more_info_model', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
                    ...
                    $('#action_plan').click(function(e) {
                        function generateTableRow(serialNumber) {
                            ...
                            html += '</select></td>' +
                                ...
                                serialNumber +
                                '" readonly placeholder="DD-MM-YYYY" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" /><input type="date" name="deadline[]" class="hide-input" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" oninput="handleDateInput(this, `deadline' +
                    ...
                    $('#action_plan2').click(function(e) {
                        function generateTableRow(serialNumber) {
                            ...
                            var html =
                                ...
                                serialNumber +
                                '" readonly placeholder="DD-MM-YYYY" /><input type="date" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="deadline2[]" class="hide-input" oninput="handleDateInput(this, `deadline2' +
                    serialNumber + '`)" /></div></div></div></td>' +
