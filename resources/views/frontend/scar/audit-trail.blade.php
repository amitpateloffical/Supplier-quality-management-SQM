                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('rcms/scar-show/' . $document->id) }}"> Back
                                </a>
                            </button>
                            ...
                            <div class="modal-content">
                                ...
                                @php
                                    $reviewer = DB::table('audit_reviewers_details')
                                        ->where(['doc_id' => $document->id, 'type' => 'SCAR'])
                                        ->get();
                                @endphp
                                ...
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" id="type" name="type" value="SCAR">
                                        </div>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                                ...
                                <div>
                                    <strong> Action Name :</strong>
                                     @if($dataDemo->action == "Notification")
                                        <a href="{{ route('notification-detail', ['slug' => 'SCAR', 'id' => $dataDemo->id]) }}" target = "_blank">{{ $dataDemo->action ? $dataDemo->action : 'Not Applicable' }}<a>
                                    @else
                            ...
                            <td>
                                ...
                                <div style="margin-top: 5px;"> <strong>Performed On
                                        :</strong>{{ \Carbon\Carbon::parse($dataDemo->created_at)->format('d-m-Y H:i:s') ? \Carbon\Carbon::parse($dataDemo->created_at)->format('d-M-Y H:i:s') : 'Not Applicable' }}
                                </div>
