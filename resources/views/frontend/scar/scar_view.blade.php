                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1"> <a class="text-white"
                                href="{{ url('rcms/scar-audit-trail', $data->id) }}"> Audit Trail </a> </button>

                        @if ($data->stage == 1 && Helpers::check_roles($data->division_id,'SCAR',18))
                            ...
                            <!--    Cancel-->
                            <!--</button>-->
                        @elseif($data->stage == 2 && Helpers::check_roles($data->division_id,'SCAR',18))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Acknowledged
                            </button>
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id,'SCAR',18))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Work in Progress
                            </button>
                        @elseif($data->stage == 4 && Helpers::check_roles($data->division_id,'SCAR',18))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Submit Response
                            </button>
                        @elseif($data->stage == 5 && Helpers::check_roles($data->division_id,'SCAR',18))
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" disabled
                                            value="{{ Helpers::getDivisionName($data->division_id) }}/SCAR/{{ date('Y') }}/{{ str_pad($data->record, 4, '0', STR_PAD_LEFT) }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="supplier_site" @if ($data->stage >= 6) disabled @endif>
                                            ...
                                            <option value="supplier-site-1"
                                                @if ($data->supplier_site == 'supplier-site-1') selected @endif>Supplier Site-1</option>
                                            <option value="supplier-site-2"
                                                @if ($data->supplier_site == 'supplier-site-2') selected @endif>Supplier Site-2</option>
                                            <option value="supplier-site-3"
                                                @if ($data->supplier_site == 'supplier-site-3') selected @endif>Supplier Site-3</option>
                                            <option value="supplier-site-4"
                                                @if ($data->supplier_site == 'supplier-site-4') selected @endif>Supplier Site-4</option>
                                            <option value="supplier-site-5"
                                                @if ($data->supplier_site == 'supplier-site-5') selected @endif>Supplier Site-5</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="supplier_product" @if ($data->stage >= 6) disabled @endif>
                                            ...
                                            <option value="supplier-product-2"
                                                @if ($data->supplier_product == 'supplier-product-2') selected @endif>Supplier Product-2
                                            </option>
                                            <option value="supplier-product-3"
                                                @if ($data->supplier_product == 'supplier-product-3') selected @endif>Supplier Product-3
                                            </option>
                                            <option value="supplier-product-4"
                                                @if ($data->supplier_product == 'supplier-product-4') selected @endif>Supplier Product-4
                                            </option>
                                            <option value="supplier-product-5"
                                                @if ($data->supplier_product == 'supplier-product-5') selected @endif>Supplier Product-5
                                            </option>
