            ...
            <header>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttons-new">
                        @if ($document->stage < 6) <button class="button_theme1" data-bs-toggle="modal"
                            data-bs-target="#auditReviewer">
                            Review
                            </button>
                            @endif
                ...
                <div class="modal fade" id="auditViewers">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            ->where(['doc_id' => $document->id, 'type' => 'Supplier Site'])
                            ->get();
                            @endphp
                            ...
                            <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="group-input">
                                        ...
                                        <textarea {{ $auditCollect ? 'disabled' : '' }} class="summernote w-100"
                                            name="reviewer_comment"
                                            id="summernote-17">{{ $auditCollect ? $auditCollect->reviewer_comment : '' }}</textarea>
                                    </div>
                                    <div class="group-input">
                                    ...
                                    <input type="hidden" id="type" name="type" value="Supplier Site">
                                </div>
                ...
                <table>
                    <div class="heading">
                        ...
                        <div> <strong>Record ID.</strong>
                            {{ Helpers::getDivisionName(session()->get('division')) }}/SS/{{ Helpers::year($document->created_at) }}/{{ str_pad($document->record, 4, '0', STR_PAD_LEFT) }}
                        </div>
