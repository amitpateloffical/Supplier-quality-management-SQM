                    ...
                    <div class="inner-block-content">
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input name="supplier_products" id="supplier_products" class="mic-input"
                                        type="text">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                        ...
                        <div class="col-12">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <textarea name="description" class="mic-input" placeholder></textarea>
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input type="text" name="supply_from" class="mic-input"
                                        placeholder="Enter Supply From">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input type="text" name="supply_to" class="mic-input"
                                        placeholder="Enter Supply To">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input type="text" name="supplier_website" class="mic-input"
                                        placeholder="Enter Supply Website">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input type="search" name="supplier_web_search" class="mic-input"
                                        placeholder="Enter Supply Web Search">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <div style="position:relative;">
                                    <input type="text" name="related_quality_events" class="mic-input"
                                        placeholder="Enter Related Quality Events">
                                    <button class="mic-btn" type="button">
                                        <i class="fas fa-microphone"></i>
                                    </button>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea type="text" name="HOD_feedback" class="mic-input" placeholder="Enter HOD Feedback" id="HOD_feedback"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea type="text" name="HOD_comment" class="mic-input" placeholder="Enter HOD Comment" id="HOD_comment"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <table class="table table-bordered" id="certificationDataTable">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input type="text" value="1" name="certificationData[]" readonly>
                                        </td>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            <label for="Supplier.">Supplier</label>
                            <div style="position:relative;">
                                <input type="text" name="supplier_name" class="mic-input" id="supplier_name"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="supplier_id" class="mic-input"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="manufacturer_name" class="mic-input"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="manufacturer_id" class="mic-input"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="vendor_name" class="mic-input"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            <label for="Contact Person">Contact Person</label>
                            <div style="position:relative;">
                                <input type="text" name="contact_person" class="mic-input" id="contact_person"
                    ...
                    <div class="col-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea name="other_contacts" class="mic-input" id="other_contacts"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea name="supplier_serivce" class="mic-input" id="supplier_serivce" cols="30"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            <label for="Supplier Web Site">Supplier Web Site</label>
                            <div style="position:relative;">
                                <input type="text" name="suppplier_web_site" class="mic-input"
                                    id="suppplier_web_site" placeholder="Enter Website ">
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="suppplier_contacts" class="mic-input"
                                    id="suppplier_contacts">
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" name="related_non_conformance" class="mic-input"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" id="suppplier_agreement" class="mic-input"
                                    name="suppplier_agreement">
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" id="regulatory_history" class="mic-input"
                                    name="regulatory_history">
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <input type="text" id="distribution_sites" class="mic-input"
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea name="manufacturing_sited" class="mic-input" id="manufacturing_sited"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea id="quality_management" class="mic-input" name="quality_management"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea id="bussiness_history" class="mic-input" name="bussiness_history"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea id="performance_history" class="mic-input" name="performance_history"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea id="compliance_risk" class="mic-input" name="compliance_risk"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea type="text" name="QA_reviewer_feedback" class="mic-input" placeholder="Enter QA Reviewer Feedback"
                                    id="QA_reviewer_feedback"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea type="text" name="QA_reviewer_comment" class="mic-input" placeholder="Enter QA Reviewer Comment"
                                    id="QA_reviewer_comment"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select id="previous_audit_result" name="previous_audit_result">
                                <option value="">Enter Your Selection Here</option>
                                <option value="Below Requirement Major NCN's or No Audit History">Below Requirement
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div style="position:relative;">
                                <textarea type="text" name="QA_head_comment" class="mic-input" placeholder="Enter QA Head Comment"
                                    id="QA_head_comment"></textarea>
                                <button class="mic-btn" type="button">
                                    <i class="fas fa-microphone"></i>
                                </button>
                            </div>
