                ...
                <div class="mail-content">
                    ...
                    <div class="table-wrapper">
                        ...
                        <table class="fl-table">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 10%">{{ Helpers::record($data->record) }}</td>
                                    <td style="width: 10%">{{ Helpers::getDivisionName($data->division_id) }}</td>
                                    {{-- <td>{{ Helpers::getInitiatorName($data->initiator_id) }}</td> --}}
                                    <td style="width: 40%">{{ $data->short_description }}</td>
                                    {{-- <td>{{ Helpers::getDateFormat($data->created_at) }}</td> --}}
                                    <td style="width: 10%">{{ Helpers::getDateFormat($data->due_date) }}</td>
                                    <td style="width: 30%">{{ $data->status }}</td>
                                </tr>
                            <tbody>
                        </table>
                    </div>
                    <div class="mt-5">
                        <p>The {{ $history }} performed by {{ $user }} </p>
                        <p>This notification has been automatically generated by the QMS System.</p>
                    </div>
